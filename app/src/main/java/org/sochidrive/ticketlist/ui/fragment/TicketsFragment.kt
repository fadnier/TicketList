...
class TicketsFragment: MvpAppCompatFragment(), BackButtonListener, TicketsView {

    companion object {
        private const val MANAGER_ARG = "manager"

        fun newInstance(manager: Manager) = TicketsFragment().apply {
    ...
    val presenter by moxyPresenter {
        ...
        TicketsPresenter(managers).apply { App.instance.appComponent.inject(this) }
    }
